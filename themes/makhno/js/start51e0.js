...
$(function () {
	...
	//video progress and hide show after user play it all
	if (videoBox.length) {
	...
	videoBox.on('ended', function () {
		// Cookies.set('video-played-' + videoBox.find('source').attr('src'), true, {expires: 1, domain: document.domain, path: "/"});
